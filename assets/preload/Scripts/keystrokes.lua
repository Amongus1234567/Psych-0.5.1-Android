function onCreatePost()
    ...
    makeLuaText('upText', 'J', 60, getProperty('upButton.x'), getProperty('upButton.y') + 20)
    ...
    makeLuaText('downText', 'F', 60, getProperty('downButton.x'), getProperty('downButton.y') + 20)
    ...
    makeLuaText('leftText', 'D', 60, getProperty('leftButton.x') + 2, getProperty('leftButton.y') + 20)
    ...
    makeLuaText('rightText', 'K', 65, getProperty('rightButton.x') - 2, getProperty('rightButton.y') + 20)
